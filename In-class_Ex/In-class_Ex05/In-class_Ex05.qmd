...
global_moran_test(wm_q$GDPPC,
                  ...
                  wm_q$wt)
```
now, since people will question your wj
we will use permutate to test the significance of the moran I
...
```
:::callout note
Te number of simulation is always equal to nsim +! this mean in nsim = 99 this mean 100 simulations will be 
