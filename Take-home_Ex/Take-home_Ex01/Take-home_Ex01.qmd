...
```
There are 9 invalid geometries in mpsz_sf and 0 invalid geometry in roads_sf. 
...
## 5.3) convert roads_sf into 3414 
...
write_rds(mpsz_sf_3414, "data/rds/mpsz_sf_3414.rds")
write_rds(roads_sf_3414, "data/rds/roads_sf_3414.rds")
```
...
mpsz_sf_3414 <- read_rds("data/rds/mpsz_sf_3414.rds")
roads_sf_3414 <- read_rds("data/rds/roads_sf_3414.rds")
```
